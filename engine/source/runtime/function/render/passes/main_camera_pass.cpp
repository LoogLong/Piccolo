...
namespace Piccolo
{
    ...
    {
        buildMainCameraRenderPass(m_rhi.get(),
                                  m_framebuffer,
                                  m_enable_fxaa,
                                  MainCameraRenderPassKind::Raster,
    ...
    void MainCameraPass::setupPathTracingCompositeRenderPass()
    {
        buildMainCameraRenderPass(m_rhi.get(),
                                  m_framebuffer,
                                  m_enable_fxaa,
                                  MainCameraRenderPassKind::PathTracingComposite,
                                  m_path_tracing_composite_render_pass);
    }
    ...
    {
        buildMainCameraSwapchainFramebuffers(m_rhi.get(), m_framebuffer, m_framebuffer.render_pass, m_swapchain_framebuffers);
    }

    void MainCameraPass::setupPathTracingCompositeSwapchainFramebuffers()
    {
        buildMainCameraSwapchainFramebuffers(
            m_rhi.get(), m_framebuffer, m_path_tracing_composite_render_pass, m_path_tracing_composite_swapchain_framebuffers);
    }
